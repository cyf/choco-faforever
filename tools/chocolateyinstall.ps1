...
$url        = 'https://github.com/cyf/faforever/releases/download/v0.0.0%2B21/FaForever_0.0.0.21_x86_en-US.msi' # download url, HTTPS preferred
$url64      = 'https://github.com/cyf/faforever/releases/download/v0.0.0%2B21/FaForever_0.0.0.21_x64_en-US.msi' # 64bit URL here (HTTPS preferred) or remove - if installer contains both (very rare), use $url
...
$packageArgs = @{
  ...
  softwareName  = 'faforever*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
...
## https://stackoverflow.com/questions/35558911/why-is-the-uninstall-chocolateypackage-cmdlet-not-recognized/35579220#35579220
